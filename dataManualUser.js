module.exports = [
	{
		...
		"guides": [
			...
			"Al consultar niños/as con etado activo, aparece una opción adicional para consultar por el estado de estimulación. Opciones: Registrado, En Cursos, Calificado, Retirado y Todos.",
			"En el resultado de la consulta el ID de cada niño/usuario es un link para ver información mas detallada del mismo.",
			"Puede exportar el reporte a un archivo PDF al dar clic en el botón Generar PDF (E).",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"Verifique que el número de identificación sea correcto."
		...
		"guides": [
			...
			"Puede exportar toda la información a un archivo PDF al dar clic en el botón Generar PDF (I).",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"No Aplica."
		...
		"guides": [
			...
			"Dar clic en Consultar (D).",
			"En el resultado de la consulta el ID de cada niño es un link para ver información mas detallada del mismo.",
			"Puede exportar toda la información a un archivo PDF al dar clic en el botón Generar PDF (E).",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"No Aplica."
