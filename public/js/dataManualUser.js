var manual = [
	{
		...
		"includes": ["1.3"],
		"image": "![IMAGEN MENÚ PRINCIPAL](/img/help/1.4.png)",
		...
		"guides": [
			"Dar clic en la opción ADMIN USUARI@S del menú principal (A).",
			"Ubique visualmente la sección Docente/Administrador(s) (B).",
			"Digitar el número de cédula del usuario que quiere actualizar (C).",
			"Dar clic en el botón Actualizar (D).",
			"Se abre una nueva pestaña donde se muestran los campos editables con toda la información del usuario (E).",
		...
		"includes": ["2.1.1"],
		"image": "![IMAGEN ELIMINAR UN USUARIO](/img/help/2.1.6.png)",
		"description": "Permite eliminar un usuario.",
		"guides": [
			"Un usuario no puede ser eliminado.",
			"Un administrador puede inactivar a un usuario para que no pueda acceder al sistema."
		],
		"warnings": [
			"Verifique que el número de cédula sea correcto."
		]
		...
		"guides": [
			...
			"Escriba el nuevo usuario de autenticación y contraseña que serán asignados y seleccionar en la lista desplegable el tipo de usuario que le asiganará (D).",
			"Dar clic en Crear (E).",
			"En el cuadro emergente, dar clic en Aceptar",
		...
		"guides": [
			...
			"En la lista desplegable seleccionar el tipo de usuario que quiere asignar (D).",
			"Dar clic en Actualizar (E).",
			"En el cuadro emergente, dar clic en Aceptar.",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana "
		],
		...
		"includes": ["2.1.1"],
		"image": "![IMAGEN ELIMINAR UN/A NIÑO/A](/img/help/2.2.4.png)",
		...
		"warnings": [
			"Contacte a Soporte en caso de requerir eliminar un/a niño/a."
		]
	}, {
		...
		"guides": [
			...
			"En el cuadro emergente, dar clic en Aceptar.",
			"El botón Cancelar, cancela la validación sin guardar ningún dato (I).",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"Verifique que el número de identificación sea correcto.",
		...
		"includes": ["2.1.1"],
		"image": "![IMAGEN CONSULTAS GENERALES](/img/help/2.3.1.png)",
		"description": "Permite generar reportes basados en consultas generales.",
		"guides": [
			"Dar clic en la opción REPORTES del menú principal (A).",
			"Ubique visualmente la sección Consultas Generales (B).",
			"En la lista desplegable seleccionar la consulta a realizar (C).",
			"Digitar el número de identificación del/la niño/a (D).",
			"Dar clic en Consultar (E).",
			"Opción Listado General Niñ@s muestra todos los niños/as registrados en el sistema.",
			"Opción Listado General Profesores muestra todos los usuarios/as tipo Docente registrados en el sistema.",
			"Opción Listado por Etapas muestra por cada etapa existente una tabla con la lista de niños/as en esa etapa.",
			"El ID de cada niño/usuario es un link para ver información mas detallada del mismo (F).",
			"Puede exportar el reporte a un archivo PDF al dar clic en el botón Generar PDF (G).",
			"Para regresar al Menú Principal debe dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"Verifique que el número de identificación sea correcto."
		...
		"description": "Permite consulatr la información detallada de un niño/a.",
		"guides": [
			"Dar clic en la opción REPORTES del menú principal (A).",
			...
			"Opción ACTIVIDADES VALIDADAS, muestra la información de las actividades validadas (I).",
			"Opción HISTORIAL DE ACTIVIDADES, muestra el historial de todas las actividades que ha desarrollado el/la niño/a (J).",
			"Puede exportar toda la información a un archivo PDF al dar clic en el botón Generar PDF (K).",
			"Para regresar al Menú Principal debe cerrar la pestaña que se abrió tras la consulta y/o volver a la pestaña anterior (ADMIN USUARI@S), y dar clic en el botón VOLVER que se encuentra en la parte superior izquierda de la ventana."
		],
		"warnings": [
			"Verifique que el número de identificación sea correcto."
		...
		"guides": [
			...
			"Dar clic en Consultar (E).",
			"Opción Exacta, consulta todos los niños/as que tienen la edad especificada (F).",
			"Opción Mayor Que consulta todos los niños/as que tienen una edad mayor a la especificada (G).",
			"Opción Menor Que consulta todos los niños/as que tienen una edad menor a la especificada (H).",
			"El ID de cada niño es un link para ver información mas detallada del mismo (I).",
		...
		"guides": [
			...
			"Dar clic en Consultar (D).",
			"El ID de cada niño es un link para ver información mas detallada del mismo (E).",
		...
		"includes": ["2.1.1"],
		"image": "![IMAGEN GENERACIÓN DE REPORTE FINAL](/img/help/2.3.6.png)",
		...
		"guides": [
			...
			"Automáticamente se descarga un archivo correspondiente al backup en la carpeta de Descargas (Download) (C).",
		...
		"guides": [
			"Al autenticarse en el sistema con un usuario de tipo Docente automáticamente se carga el Menú Principal del Profesor (A)."
		],
		"warnings": [
		...
		"guides": [
			...
			"Para cancelar una actidad debe dar clic en Reiniciar Actidad o Cancelar (C)."
		],
		"warnings": [
			"Verifique que el número de identificación sea correcto",
		...
		"guides": [
			...
			"Niño/a Actual: Muestra el nombre, identificación y foto del/la niño/a sesleccionado. Tambien permite ver información detallada del/la niño/a y cancelar la actividad (E).",
		...
		"includes": ["3.2.3"],
		"image": "![IMAGEN VALIDACIÓN PARCIAL DE UNA ACTIVIDAD](/img/help/3.2.8.png)",
		...
		"guides": [
			...
			"Se muestra la sección Validación FinalActividad (B).",
			"Validar la información que se muestra (C).",
		...
		"includes": [],
		"image": "![IMAGEN ACCESO A ConectionRUG](/img/help/3.5.1.png)",
		...
		"guides": [
			...
			"Junto con el tapete electrónico vienen 4 containers, los cuales son pequeñas cajas en las que se insertan las fichas para poder desarrollar una actividad.",
			"Al colocar los containers con sus respectivas fichas en el tapete electrónico debe tener en cuenta el PIN (número) en donde se encuentra la ficha que corresponde a la respuesta correcta, ya que ese PIN debe configurarse en ConectionRug( A).",
		...
		"guides": [
			"Para hacer la conexión del tapete electrónico debe conectar el cable USB del tapete al puerto USB del computador.",
			"Seleccionar el PIN correcto en las lista desplegable PIN (Ver: UBICACIÓN DE FICHAS (Concordancia PIN-FICHA))",
			...
			"Para desconectar el tapete dar clic en el botón Desconectar (B)."
		],
		"warnings": [
		...
		"guides": [
			...
			"Ubique visualmente la sección ¡LÉEME! (A).",
